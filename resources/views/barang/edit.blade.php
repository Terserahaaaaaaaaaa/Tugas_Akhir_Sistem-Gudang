                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group text-center">
                                    ...
                                    <div>
                                        <img id="preview-foto"
                                             src="{{ $barang->foto ? asset('storage/' . $barang->foto) : 'https://via.placeholder.com/150x150?text=No+Image' }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="kategori_barang_id"
                                                ...
                                                @foreach ($kategori as $k)
                                                    <option value="{{ $k->id }}"
                                                        {{ old('kategori_barang_id', $barang->kategori_barang_id) == $k->id ? 'selected' : '' }}>
                                                        {{ $k->nama_akun }}
                                                    </option>
                                                @endforeach
                                            </select>
                                ...
                                {{-- <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="harga_terakhir" min="0" step="100"
                                               ...
                                               value="{{ old('harga_terakhir', $barang->harga_terakhir) }}">
